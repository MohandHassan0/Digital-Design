...
# Created by write_sdc on Wed Oct 23 22:05:44 2024
...
create_clock [get_ports scan_clk]  -name scan_clock  -period 20  -waveform {0 10}
set_clock_latency 0  [get_clocks scan_clock]
set_clock_uncertainty -setup 0.2  [get_clocks scan_clock]
set_clock_uncertainty -hold 0.1  [get_clocks scan_clock]
set_clock_transition -min -fall 0.1 [get_clocks scan_clock]
set_clock_transition -max -fall 0.1 [get_clocks scan_clock]
set_clock_transition -min -rise 0.1 [get_clocks scan_clock]
set_clock_transition -max -rise 0.1 [get_clocks scan_clock]
...
set_input_delay -clock scan_clock  4  [get_ports SI]
set_input_delay -clock scan_clock  4  [get_ports SE]
set_input_delay -clock scan_clock  4  [get_ports test_mode]
...
set_output_delay -clock scan_clock  4  [get_ports SO]
...
set_clock_groups -asynchronous -name scan_clock_1 -group [get_clocks scan_clock] -group [list [get_clocks REF_DOMAIN] [get_clocks Gated_Clock]]
set_clock_groups -asynchronous -name UART_DOMAIN_2 -group [list [get_clocks UART_DOMAIN] [get_clocks TX_CLK] [get_clocks RX_CLK]] -group [get_clocks scan_clock]
